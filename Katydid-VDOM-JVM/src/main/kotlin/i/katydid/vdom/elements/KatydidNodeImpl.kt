 ...
 */
internal abstract class KatydidNodeImpl<Msg> (
    ...
    private val childNodesByKey: MutableMap<Any, KatydidNodeImpl<Msg>> = hashMapOf()
    ...
    override val soleChildNode: KatydidNodeImpl<Msg>
        get() {
     ...
     */
    fun addChildNode(childNode: KatydidNodeImpl<Msg>) {
     ...
     */
    protected open fun afterAddChildNode(childNode: KatydidNodeImpl<Msg>) {
     ...
     */
    private fun matches(otherNode: KatydidNodeImpl<Msg>?): Boolean {
     ...
     */
    fun patch(priorNode: KatydidNodeImpl<Msg>) {
     ...
     */
    protected abstract fun patchAttributes(domElement: Node, priorElement: KatydidNodeImpl<Msg>)
     ...
     */
    private fun patchChildNodes(domNode: Node, priorNode: KatydidNodeImpl<Msg>) {
     ...
     * @param priorNode the prior edition of this Katydid-VDOM node that corresponds to the given domNode.
     */
    private fun patchEventHandlers(domNode: Node, priorNode: KatydidNodeImpl<Msg>) {
