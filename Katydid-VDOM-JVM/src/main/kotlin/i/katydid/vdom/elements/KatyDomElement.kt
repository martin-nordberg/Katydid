...
import o.katydid.vdom.elements.AbstractKatyDomElement
...
internal abstract class KatyDomElement<Msg> : KatyDomNode<Msg>, AbstractKatyDomElement<Msg> {
    ...
    final override fun patchAttributes(domElement: Node, priorElement: KatyDomNode<Msg>) {
        ...
        if (domElement !is Element) throw IllegalArgumentException("DOM node expected to be an element.")
        if (priorElement !is KatyDomElement) throw IllegalArgumentException("Katydid-VDOM node expected to be element.")
